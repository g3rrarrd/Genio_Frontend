...
const Summary: React.FC<SummaryProps> = ({ state, onRestart, onRegister, onRanking, onHome }) => {
  ...
  return (
    <div className="min-h-[100dvh] flex flex-col p-6 3xl:p-16 4k:p-40 max-w-md lg:max-w-2xl xl:max-w-4xl 2xl:max-w-5xl 3xl:max-w-7xl 4k:max-w-[2200px] mx-auto bg-background-dark overflow-x-hidden" style={{ backgroundImage: "var(--design-background-image, url('/images/fondo 3.jpg'))", backgroundSize: 'cover', backgroundPosition: 'center', backgroundRepeat: 'no-repeat' }}>
