...
const Gameplay: React.FC<GameplayProps> = ({ question, index, total, streak, difficulty, onAnswer, onHome, timeLimit, logoImage, iconVImage, iconFImage }) => {
  if (!question) {
    return (
    ...
    <div className="min-h-[100dvh] flex flex-col p-6 lg:p-12 3xl:p-20 4k:p-40 max-w-md lg:max-w-2xl xl:max-w-4xl 2xl:max-w-5xl 3xl:max-w-7xl 4k:max-w-[2200px] mx-auto w-full overflow-hidden select-none bg-[#0a0a0a]" style={{ backgroundImage: "var(--design-background-image, url('/images/fondo 3.jpg'))", backgroundSize: 'cover', backgroundPosition: 'center', backgroundRepeat: 'no-repeat' }}>
      ...
      <header className="shrink-0 pt-4 4k:pt-20 z-30 space-y-6 4k:space-y-20">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-6 4k:gap-20" style={{ backgroundImage: "var(--design-background-image, url('/images/fondo 3.jpg'))", backgroundSize: 'cover', backgroundPosition: 'center', backgroundRepeat: 'no-repeat' }}>
      ...
      >
        ...
        <div className="flex justify-center gap-16 lg:gap-32 4k:gap-[300px] pb-20 4k:pb-40">
          ...
          >
            ...
            <img src={iconFImage || '/images/icono f.svg'} alt="Falso" className="size-12 lg:size-20 4k:size-[200px] object-contain" />
          </button>
          ...
          >
            ...
            <img src={iconVImage || '/images/icono v.svg'} alt="Verdadero" className="size-12 lg:size-20 4k:size-[200px] object-contain" />
          </button>
        </div>
      </main>
